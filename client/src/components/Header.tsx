    ...
    <header className="bg-white shadow-sm">
      <div className="container mx-auto px-4 py-4 flex justify-between items-center">
        <div className="flex items-center">
          ...
          <h1 className="font-google-sans text-2xl font-medium text-gray-900">Gmail HTML Formatter</h1>
        </div>
        <div className="hidden md:flex items-center space-x-4">
          <a 
            href="https://support.google.com/mail/answer/176654" 
            target="_blank" 
          ...
          >
            ...
            <span className="text-sm">Gmail HTML Help</span>
          </a>
        </div>
      </div>
    </header>

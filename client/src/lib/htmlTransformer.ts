      ...
      <table style="width:100%;" cellpadding="0" cellspacing="0" border="0">
        <tr>
            ...
            <table style="width:100%;" cellpadding="0" cellspacing="0" border="0">
              <tr>
                <td style="width:40px; vertical-align:middle;">
                  <img src="https://i.imgur.com/JSKQCrM.png" alt="Profile Photo" style="display:block; width:40px; height:40px; border-radius:20px; border:1px solid #eeeeee; object-fit:cover; image-rendering:high-quality; -ms-interpolation-mode:bicubic;">
                </td>
                <td style="padding-left:12px; vertical-align:middle;">
                  <div style="font-size:16px; font-weight:bold; color:#333333;">Phillipp Ruckert</div>
                  <div style="font-size:12px; color:#666666;">Chairman of The Board</div>
                </td>
              </tr>
            </table>
          </td>
          ...
          <td style="width:40%; text-align:right; vertical-align:middle;">
            <img src="https://i.imgur.com/3WY94Zj.png" alt="Company Logo" style="display:block; max-width:120px; width:auto; height:40px; border:none; margin-left:auto; image-rendering:high-quality; -ms-interpolation-mode:bicubic;">
          </td>
        </tr>
      </table>
    </td>
